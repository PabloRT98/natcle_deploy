...
<form name="pdf24Form" method="post" onsubmit="return pdf24_checkForm(this)">
	...
	<div>
		...
		<tr>
			...
			<td class="tr2"><input type="text" name="docHeader" style="width:600px" value="<?php echo htmlspecialchars(pdf24Plugin_getDocHeader()); ?>" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="tr2"><input type="text" name="docDefaultFilename" style="width:600px" value="<?php echo htmlspecialchars(pdf24Plugin_getDocFilename('default')); ?>" />
			<br /><small>Allowed placeholders: <b>{blogName}, {date:FORMAT}</b></small></td>
		</tr>
		<tr>
			<td class="tr1" height="60">Filename for home page:</td>
			<td class="tr2"><input type="text" name="docHomeFilename" style="width:600px" value="<?php echo htmlspecialchars(pdf24Plugin_getDocFilename('home')); ?>" />
			<br /><small>Allowed placeholders: <b>{blogName}, {date:FORMAT}</b></small></td>
		</tr>
		<tr>
			<td class="tr1" height="60">Filename for single post pages:</td>
			<td class="tr2"><input type="text" name="docSingleFilename" style="width:600px" value="<?php echo htmlspecialchars(pdf24Plugin_getDocFilename('single')); ?>" />
		...
		<tr>
			...
			<td class="tr2"><input type="text" name="docPageFilename" style="width:600px" value="<?php echo htmlspecialchars(pdf24Plugin_getDocFilename('page')); ?>" />
		...
		<tr>
			...
			<td class="tr2"><input type="text" name="docCategoryFilename" style="width:600px" value="<?php echo htmlspecialchars(pdf24Plugin_getDocFilename('category')); ?>" />
		...
		<tr>
			...
			<td class="tr2"><input type="text" name="docSearchFilename" style="width:600px" value="<?php echo htmlspecialchars(pdf24Plugin_getDocFilename('search')); ?>" />
	...
	<div>
		...
		<h2>Article Feature</h2>
		<div class="descr">This feature displays a small box underneath or above each article to convert the article into a PDF file.</div>
		<table>
		<tr>
			<td class="tr1">Use this feature</td>
	...
	<div>
		...
		<script language="javascript"><?php  echo $styleParms['js']; ?></script>
		<h2>Sidebar Feature & Sidebar Widget Feature</h2>
		<div class="descr">This feature adds a widget to your Wordpress blog. Look at the widget section in your wordpress admin area to put the widget into the sidebar.<br />
	...
	<div>
		...
		<script language="javascript"><?php  echo $styleParms['js']; ?></script>
		<h2>Top Bottom Feature</h2>
		<div class="descr">This feature displays a small box everywhere in your blog where you place some peace of code in a template of your theme.<br />
	...
	<div>
		...
		<script language="javascript"><?php  echo $styleParms['js']; ?></script>
		<h2>Link Feature</h2>
		<div class="descr">This feature displays a link everywhere in your blog where you place some peace of code in a template of your theme.<br />
	...
	<div>
		...
		<h2>Custom document template</h2>
	...
	<div>
		...
		<h2>Custom document entry template</h2>
	...
	<p class="submit">
		<input class="button button-primary" type="submit" name="update" value="Save Changes" style="font-weight:bold;" />
	</p>
</form>   
</div>